...
public static class FnvVectors
{
    ...
    private static IEnumerable<byte[]> buildBytes()
    {
        ...
        yield return repeat10([0x54, 0xc5]);
        yield return repeat10([0xc5, 0x54]);
        yield return repeat10("23209");
        yield return repeat10("M23209");
        yield return repeat10("2^23209-1");
        yield return repeat10([0x5a, 0xa9]);
        yield return repeat10([0xa9, 0x5a]);
        yield return repeat10("391581216093");
        yield return repeat10("391581*2^216093-1");
        yield return repeat10([0x05, 0xf9, 0x9d, 0x03, 0x4c, 0x81]);
        yield return repeat10("FEDCBA9876543210");
        yield return repeat10([0xfe, 0xdc, 0xba, 0x98, 0x76, 0x54, 0x32, 0x10]);
        yield return repeat10("EFCDAB8967452301");
        yield return repeat10([0xef, 0xcd, 0xab, 0x89, 0x67, 0x45, 0x23, 0x01]);
        yield return repeat10("0123456789ABCDEF");
        yield return repeat10([0x01, 0x23, 0x45, 0x67, 0x89, 0xab, 0xcd, 0xef]);
        yield return repeat10("1032547698BADCFE");
        yield return repeat10([0x10, 0x32, 0x54, 0x76, 0x98, 0xba, 0xdc, 0xfe]);
        yield return repeat500([0]);
        yield return repeat500([0x07]);
        yield return repeat500("~");
        yield return repeat500([0x7f]);
    }
}